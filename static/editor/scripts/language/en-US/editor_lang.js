...
function getTxt(s)
  ...
  switch(s)
    ...
    case "Numbering":return "有序列表";
    case "Bullets":return "无序列表";
    case "Indent":return "向左缩进";
    case "Outdent":return "向右缩进";
    case "Left To Right":return "Left To Right";
    case "Right To Left":return "Right To Left";
    case "Foreground Color":return "字体颜色";
    ...
    case "Preformatted":return "保留格式";
    case "Normal (P)":return "普通文本";
    case "Normal (DIV)":return "普通段落(DIV)";
    ...
    case "Remove Formatting":return "清除格式";
