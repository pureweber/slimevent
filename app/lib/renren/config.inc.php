...
$config->APPID		= '211462';	//你的API Key，请自行申请
$config->APIKey		= 'c750d9624d08427ca4f4b0dbde793e87';	//你的API Key，请自行申请
$config->SecretKey	= '2d6503d299014da5981e21b873b82b55';	//你的API 密钥
$config->APIVersion	= '1.0';	//当前API的版本号，不需要修改
$config->decodeFormat	= 'json';	//默认的返回格式，根据实际情况修改，支持：json,xml

//$config->redirecturi= 'http://127.0.0.1/slimevent/renren.php';//你的获取code的回调地址，也是accesstoken的回调地址
$config->redirecturi= 'http://127.0.0.1/slimevent/login?way=renren';//你的获取code的回调地址，也是accesstoken的回调地址
